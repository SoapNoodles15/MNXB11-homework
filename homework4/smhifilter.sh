...
log "Filtering on only measurements taken on 26 April at 12 or 13, writing to $FILTER_FILTERNAME_ONLY26APRIL"
grep '\-04\-26,1[2-3]:00:00' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLY26APRIL